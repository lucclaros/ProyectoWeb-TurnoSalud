            ...
            var objAjax = $.ajax({
                ...
                success: function(respuestaDelServer, estado) {
                    ...
                    objJson.especialidades.forEach(function(value) {
                        ...
                        document.getElementById("id_especialidad").appendChild(objOption);
                    });
                    document.getElementById("id_especialidad").value = objJson.id_especialidad;
    ...
    <main>
        <div class="tarjeta">
            ...
            <div class="contenedor">
                <a href="./agenda_doctor.php"><img src="" alt="" class="icono">&ensp;Mi agenda</a>
                <br>
